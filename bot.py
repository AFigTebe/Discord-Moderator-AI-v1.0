...
async def on_message(message):
  translated = ts.translate_text(message.content, to_language='ru')
  santiment = request_sentiment(translated  ) #send request and get answer
  if santiment == 'positive':
    if message.author.bot == False:
      print('Позитивное сообщение: ' + santiment, '(', message.content, ')', message)
  elif santiment == 'neutral':
    if message.author.bot == False:
      print('Нормальное сообщение: ' + santiment, '(', message.content, ')', message)
  elif santiment == 'negative': 
    print('Негативное сообщение: ' + santiment, '(', message.content, ')', message)
